...
if ($opcion == "listar") { ?>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row->fechaVencimiento;
                            ?></td>
                        <td scope="col">


                            <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-target="#myModal_editar" onclick="btn_editar('<?php echo $idTarjeta; ?>');">Editar</button>

                        </td>
                        <td scope="col">

                            <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#myModal_eliminar" onclick="btn_eliminar('<?php echo $idTarjeta; ?>');">Eliminar</button>
  ...
  <?php }
if ($opcion == "editara") {
  foreach ($tarjetass->result() as $row) {
  ?>
    ...
    <div class="container">
      ...
      <div class="row">
        <input type="hidden" class="form-control" id="idTarjeta_edi" aria-describedby="emailHelp" value="<?php echo $row->idTarjeta ?>">
        <div class="col-12">
          <label for="exampleInputEmail1" class="form-label">Código</label>
          <input type="text" class="form-control" required name="codigo" id="codigo_edi" aria-describedby="emailHelp" value="<?php echo $row->codigo; ?>">
        </div>

        <div class="col-lg-12">
          <label for="exampleInputEmail1" class="form-label">Fecha De Vencimiento</label>
          <input type="date" class="form-control" required name="fechaVencimiento" id="fechaVencimiento_edi" aria-describedby="emailHelp" value="<?php echo $row->fechaVencimiento; ?>">
        </div>
...
if ($opcion == "formulario") {
  ?>
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <label for="exampleInputEmail1" class="form-label">Código</label>
          <input type="text" class="form-control" required name="codigo" id="codigo" aria-describedby="emailHelp">
        </div>

        <div class="col-lg-12">
          <label for="exampleInputEmail1" class="form-label">Fecha De Vencimiento</label>
          <input type="date" class="form-control" required name="fechaVencimiento" id="fechaVencimiento" aria-describedby="emailHelp">
        </div>
        <div class="col-lg-12">
          <label for="exampleInputEmail1" class="form-label">Saldo</label>
          <input type="number" class="form-control" required name="saldoTarjeta" id="saldoTarjeta" aria-describedby="emailHelp">
        </div>
      </div>
    </div>
  ...
  if ($opcion == "eliminar") {
    foreach ($tarjetasss->result() as $row) {
    ...
    ?>
      ...
      <div class="container">
        ...
        <!-- <div class="col-md-4 col-xs-12"> -->
        <div class="row">
          <input type="hidden" class="form-control" id="idTarjeta_eli" aria-describedby="emailHelp" value="<?php echo $row->idTarjeta ?>">
